...
/**
 * Util for converting type names between 'package DBMS_METADATA' and 'table
 * USER_OBJECTS' formats
 * 
...
public class TypeNamesUtil {
	...
	/**
	 * Oracle types in user_table without underscore, for example PACKAGE BODY but
	 * in DBMS_METADATA with underscore PACKAGE_BODY
	 * 
	 * @param type
	 *                 - type name from user_table and advanced config
	 *
	 ...
	 * 
	 * @param type
	 *                 - type name from DBMS_METADATA representation
	 *
